...
- Питай користувача лише коли:
  * потрібні macOS permissions (Automation/Accessibility/Screen Recording/Shortcuts тощо), або
  * ціль неоднозначна і неправильний вибір може призвести до помилкових/незворотних дій.
