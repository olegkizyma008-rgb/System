...
Якщо ти бачиш в історії, що попередні спроби виконати крок провалилися або призвели до "uncertain" стану — НЕ ПОВТОРЮЙ той самий крок без змін. Змінюй підхід, додавай більше діагностичних кроків або спробуй інший інструмент (наприклад, інший пошуковик або метод Native замість GUI). Твоя мета — знайти шлях до SUCCESS, уникаючи повторення помилок.
