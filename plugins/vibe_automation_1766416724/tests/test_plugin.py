"""Tests for vibe_automation_1766416724 plugin."""
...
def test_plugin_meta():
    ...
    from plugins.vibe_automation_1766416724.plugin import PLUGIN_META
    
    assert PLUGIN_META.name == "vibe_automation_1766416724"
...
def test_plugin_register():
    ...
    from plugins.vibe_automation_1766416724.plugin import register
