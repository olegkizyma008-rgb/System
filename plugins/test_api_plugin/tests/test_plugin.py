"""Tests for test_api_plugin plugin."""
...
def test_plugin_meta():
    ...
    from plugins.test_api_plugin.plugin import PLUGIN_META
    
    assert PLUGIN_META.name == "test_api_plugin"
...
def test_plugin_register():
    ...
    from plugins.test_api_plugin.plugin import register
